...
class LadderGame {
	...
	void showLadder() {
		...
		try {
			Thread.sleep(300);  // 0.5초 딜레이 ,  1000 > 1초 , 3000 > 3초 , 100 > 0.1초 
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	void setMenu() {
		...
		if 		(yIdx == 0)  menu = "김밥";
		else if (yIdx == 1)  menu = "우유";
		else if (yIdx == 2)  menu = "치킨";
		else if (yIdx == 3)  menu = "따아";
		else if (yIdx == 4)  menu = "피자";
